...
class FaceMatchAutoFixTest extends TestCase
{
    use WithoutMiddleware;

    public function test_facematchautofix_all_true()
    {
        $data = [
        ...
        $respons = $this->post(route('face.match.autofix'), $data);
        $respons->assertJson(
                                [
                                    'status' => 200, 
                                    'errors' => null    
    ...
    public function test_facematchautofix_invalidparameter()
    {
        $data = [
            "trx_id" => "completeidautofix01",
            "nik" => "",
