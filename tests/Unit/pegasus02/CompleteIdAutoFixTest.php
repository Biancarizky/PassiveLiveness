...
class CompleteIdAutoFixTest extends TestCase
{
    use WithoutMiddleware;

    public function test_completeidautofix_all_true()
    {
        $data = [
        ...
        $respons = $this->post(route('completeid.autofix'), $data);
        $respons->assertJson(
                                [
                                    'status' => 200, 
                                    'errors' => null    
    ...
    public function test_completeidautofix_invalidparameter()
    {
        $data = [
            "trx_id" => "completeidautofix01",
            "nik" => "",
